...
import { PlusCircle, Trash2, Edit, Bot, Zap, TrendingUp, Activity, Upload, Save, Loader2, X } from "lucide-react";
...
export default function AgentsManagement() {
  ...
  return (
    <div className="admin-full-width space-y-6 w-full max-w-none overflow-hidden">
      ...
      {/* Tabela de Agentes */}
      <Card className="bg-gray-800/50 backdrop-blur-sm border-gray-700 w-full">
        <CardHeader>
