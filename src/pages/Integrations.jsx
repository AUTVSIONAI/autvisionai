...
const statusConfig = {
  connected: { text: "Conectado", color: "bg-green-100 text-green-800", icon: CheckCircle, iconColor: "text-green-500" },
  disconnected: { text: "Desconectado", color: "bg-gray-100 text-gray-800", icon: X, iconColor: "text-gray-500" },
  pending: { text: "Pendente", color: "bg-yellow-100 text-yellow-800", icon: Clock, iconColor: "text-yellow-500" },
  error: { text: "Erro", color: "bg-red-100 text-red-800", icon: AlertCircle, iconColor: "text-red-500" }
};
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600">Conecte seus apps e serviços para turbinar o Vision.</p>
              </div>
            </div>
            <Button
              ...
              return (
                ...
                >
                  <Card className={`overflow-hidden transition-all duration-300 h-full flex flex-col ${
                    ...
                    <div className="p-4 bg-gray-50/50 border-t mt-4">
                      {integration.status === 'connected' ? (
