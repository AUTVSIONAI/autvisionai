        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">OPERAÇÃO RESTAURAR E AVANÇAR</h1>
                <p className="text-gray-600">Tutorial e Templates de Rotina</p>
              </div>
            </div>
            <Button
          ...
          {/* Routines Grid */}
          <div>
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Suas Rotinas Criadas</h2>
            {isLoading ? (
              <p className="p-8 text-gray-700">Carregando rotinas...</p>
            ) : Array.isArray(routines) && routines.length === 0 ? (
              <p className="text-gray-500 text-center py-8">Você ainda não tem nenhuma rotina. Use um template para começar!</p>
                    ...
                    return (
                      ...
                      >
                        <Card className={`overflow-hidden transition-all duration-300 h-full flex flex-col ${
                          ...
                          <CardFooter className="flex justify-between items-center bg-gray-50/50 border-t pt-4">
